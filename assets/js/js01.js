...
//tipo de dato null 
//una variabñe que intensionalmente se borra el tipo de dato
let myVarNull; //undefined
console.log( `Tipo de dato undefined: ${myVarNull}`); //undefined
...
console.log(`Tipo de dato myVarNull: ${myVarNull === null }`); //true